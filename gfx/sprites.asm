...
BrockSprite::             INCBIN "gfx/gssprites/brock.2bpp"
MistySprite::             INCBIN "gfx/gssprites/misty.2bpp"
LtSurgeSprite::           INCBIN "gfx/gssprites/surge.2bpp"
ErikaSprite::             INCBIN "gfx/gssprites/erika.2bpp"
KogaSprite::             INCBIN "gfx/sprites/koga.2bpp"
BlaineSprite::            INCBIN "gfx/gssprites/blaine.2bpp"
SabrinaSprite::           INCBIN "gfx/gssprites/sabrina.2bpp"