...
PalPacket_TrainerCard:    PAL_SET PAL_MEWMON, PAL_BADGE, PAL_HERO, PAL_YELLOWMON
PalPacket_Generic:        PAL_SET PAL_MEWMON, 0, 0, 0
PalPacket_NidorinoIntro:  PAL_SET PAL_NIDORINO, PAL_BLACK, 0, 0
PalPacket_GameFreakIntro: PAL_SET PAL_GAMEFREAK, PAL_HERO, PAL_VIRIDIAN, PAL_BLUEMON
